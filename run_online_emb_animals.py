...
NPZ_PATH  = os.path.join("features_out", "X_emb_animals.npz")
META_PATH = os.path.join("features_out", "meta_emb_animals.csv")
...
def main():
    ...
    # PCA para estabilidad y velocidad
    ...
    print("=== ONLINE CONSTRAINED KMEANS | EMB ANIMALS (PCA=50) ===")
    print("k:", k)
